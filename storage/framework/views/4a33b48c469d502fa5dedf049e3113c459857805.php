...
<footer id="contact" class="footer-area bg-slate-800 text-white font-sans-lato">
    <div class="flex flex-wrap footer-widget justify-between p-3 py-14 max-w-[960px] mx-auto section-padding">
      ...
      <!-- قسم معلومات عن المطعم -->
      <div class="basis-[300px] grow shrink p-5 pr-9 single-widget single-widget1">
        <a href="/"><img class="w-36 h-auto" src="assets/images/logo/logo2.png" alt="شعار المطعم" /></a>
        <p class="mt-3 leading-normal">
          استمتع بأشهى الأطباق التي تأخذك في رحلة مليئة بالنكهات والمذاقات الفريدة،
          حيث نحرص على تقديم تجربة طعام استثنائية مع كل وجبة.
        </p>
      </div>

      <!-- قسم معلومات الاتصال -->
      <div class="single-widget single-widget2 leading-loose p-5 pr-7">
        <h5 class="mb-2 font-bold font-cursive-merie text-lg capitalize text-amber-400">تواصل معنا</h5>
        <div class="flex items-start">
          <i class="fa fa-map-marker pr-3 pl-1 pt-2.5"></i>
          <p>
            123 شارع الجمهورية، <br />
      ...
      <div class="single-widget single-widget3 leading-loose p-5 justify-self-end">
        <h5 class="mb-2 font-bold font-cursive-merie text-lg capitalize text-amber-400">ساعات العمل</h5>
        <p>الإثنين ...................... مغلق</p>
        <p>الثلاثاء - الجمعة .......... 10 صباحًا - 12 مساءً</p>
        <p>السبت - الأحد ............... 8 صباحًا - 11 مساءً</p>
        <p>العطلات .................... 10 صباحًا - 12 مساءً</p>
      </div>
    </div>
    ...
    <div class="footer-copyright py-3 text-white bg-slate-900">
      <div class="flex flex-wrap items-center max-w-[960px] mx-auto px-3 justify-between">
        ...
        <ul class="social-icons flex flex-wrap my-3 mx-5 transition ease-in-out duration-300">
          <li class="mr-4 my-1">تابعنا على:</li>
  ...
  <!-- منطقة التذييل تنتهي -->
<?php /**PATH E:\bussiness\restaurant-site-laravel\resources\views/home/partials/footer.blade.php ENDPATH**/ ?>