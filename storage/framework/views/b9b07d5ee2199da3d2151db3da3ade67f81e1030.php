      ...
      <div class="card">
        <div class="card-body">
          <div class="d-sm-flex align-items-center mb-4">
            ...
            <a href="<?php echo e(route('testimonial.index')); ?>" class="text-dark ml-auto mb-3 mb-sm-0">عرض جميع الحجوزات</a>
          </div>
          <div class="table-responsive border rounded p-1">
            <table class="table">
              <thead>
                <tr class="bg-slate-800">
                  <?php $__currentLoopData = ["الصورة", "المقدمة", "الوصف", "التقييم", "تاريخ الإنشاء"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <tbody>
                ...
                <tr>
                  <td><img class="img-sm rounded-circle m-auto" src="<?php echo e($data->img); ?>" alt="صورة الشخص"></td>
                  <td>
...
<?php /**PATH E:\bussiness\restaurant-site-laravel\resources\views/admin/pages/home/tabledisplay1.blade.php ENDPATH**/ ?>