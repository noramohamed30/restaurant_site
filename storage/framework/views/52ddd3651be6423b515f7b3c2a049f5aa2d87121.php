...
<?php $component->withAttributes([]); ?>
	<div class="content-wrapper">
		<a href="<?php echo e(route('specialdishes.create')); ?>" class="btn btn-primary mx-2">إضافة طبق خاص</a>
	</div>
...
<?php endif; ?>
<?php /**PATH E:\bussiness\restaurant-site-laravel\resources\views/admin/pages/spdishes/spdishes.blade.php ENDPATH**/ ?>